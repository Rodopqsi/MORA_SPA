-- Ejecuta este script dentro de la base de datos mora_spa en pgAdmin.
-- Si la base no existe todavia, creala primero desde pgAdmin con el nombre mora_spa.
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'ProductImageSource') THEN
...
ADD COLUMN IF NOT EXISTS "paymentStatus" "PaymentStatus" NOT NULL DEFAULT 'PENDIENTE',
